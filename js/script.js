...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        en: {
            ...
            step3_text: 'A strict JSON prompt asks the model to choose one real TMDb film—complete with a poetic justification, vibe title, tags, and lyric-based quotes. If TMDb is missing data, Wikipedia, Brave Search, or OpenRouter backfills the gaps.',
            step4_title: 'PERSIST + share',
            step4_text: 'The final match is stored in Cloudflare KV history and rendered as poster, stills, quotes, and links. A share link with dynamic Open Graph is generated so the movie poster and synopsis appear when shared on social media. The same logic also runs in the local Python terminal version.',
            about_title: 'ABOUT',
        ...
        pt: {
            ...
            step3_text: 'Um prompt JSON estrito pede para o modelo escolher um filme real do TMDb—com uma justificativa poética, título de vibe, tags e citações baseadas na letra. Se o TMDb estiver faltando dados, Wikipedia, Brave Search ou OpenRouter completam as lacunas.',
            step4_title: 'PERSISTIR + compartilhar',
            step4_text: 'A combinação final é salva no histórico do Cloudflare KV e renderizada como pôster, stills, citações e links. Um link de compartilhamento com Open Graph dinâmico é gerado para que o pôster e a sinopse do filme apareçam quando compartilhado nas redes sociais. A mesma lógica também funciona na versão Python para terminal.',
            about_title: 'SOBRE',
