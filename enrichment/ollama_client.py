...
def gerar_estilo(contexto: str) -> dict:
    ...
    prompt = (
        ...
        "for insuficiente, use listas vazias e niveis 'unknown', e marque "
        "confidence como 'low'.\n\n"
        ...
        "- confidence: 'low' se havia pouca informação real sobre o filme "
        "(poucas keywords, overview curto), 'medium' se razoável, 'high' se "
        "havia informação rica.\n\n"
